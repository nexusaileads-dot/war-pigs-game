...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // 1. LOAD BACKGROUND
    // Note: You need background images in assets/backgrounds. 
    // If you don't have them, the game will use the solid color background from GameScene.
    ...
    // 2. LOAD LEVEL 1 ENEMIES (From sprites/enemies)
    ...
    // 3. LOAD PLAYABLE CHARACTERS (From sprites)
    // Keys must match what GameScene expects (grunt_bacon, etc.)
    ...
    // 5. LOAD PROJECTILES (From sprites)
